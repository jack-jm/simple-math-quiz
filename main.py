...
class Quiz:
  ...
  def __init__(self):
    ...
    # Creating question text, which will include num1 and num2
  ...
  def correct_incorrect(self):
    # Creating correct_answer variable which will be num1 + num2
  ...
  def generate_nums(self):
    ...
    self.num1 = random.randint(1, 10)
    self.num2 = random.randint(1, 10)
    # Configure the question text with the new numbers
