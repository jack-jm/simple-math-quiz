...
class Results:
  ...
  def assign_filename(self):
    ...
    if self.results_filename_entry.get() != "":
      ...
      if filename_validity == "valid":
        ...
        name_to_export = ("{}.txt").format(self.results_filename_entry.get())
        # Give feedback saying that it was exported
        self.results_feedback_message.config(text="Exported as {}".format(name_to_export), 
                                             fg="#1A43BF")
    ...
    # If the filename entry box is blank, then
      ...
      name_to_export = ("{}_results.txt".format(self.date_to_export))
      # Give feedback saying that it was exported
      self.results_feedback_message.config(text="Exported as {}".format(name_to_export),
                                           fg="#1A43BF")
  ...
  # This function will set the results button back to normal and close the results box
